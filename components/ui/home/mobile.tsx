    ...
    <section className='mt-10'>
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <div className="lg:py-24">
                <h2 className="text-4xl font-bold sm:text-4xl text-black">Multiple Vendors in one App.</h2>
                <p className="mt-4 text-2xl mb-2">
                    Order, Track, and Enjoy <br /> Delightful Meals
                </p>
                <p>
                    Satisfy your cravings with fast and <br /> convenient food ordering and delivery service.
                </p>
